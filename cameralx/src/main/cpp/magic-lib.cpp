...
Java_com_lx_camera_utils_EffectiveMagician_realMagic(JNIEnv *, jobject, jlong matAddr) {
    cv::Mat &imageMat = *(cv::Mat *) matAddr;
    processRealMagic(imageMat);
}

JNIEXPORT void JNICALL
Java_com_lx_camera_utils_EffectiveMagician_realMagicBW(JNIEnv *, jobject, jlong matAddr) {
    cv::Mat &imageMat = *(cv::Mat *) matAddr;
